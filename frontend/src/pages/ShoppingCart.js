                                    ...
                                    {/* cart items */}
                                    {
                                        ...
                                        (
                                            <ul>
                                                {
                                                    cartItems.map(item => (
                                                    <li key={item.product} className="md:flex items-center mt-14 py-8 border-t border-gray-200">
                                                        <Link to={`/product/${item.product}`}  className="w-60 m-auto md:m-2 ">
                                                            <img src={item.image} alt className="w-full h-full object-center object-cover" />
                                                        </Link>
                                                        <div className="md:pl-3 md:w-3/4">
                                                            {/* <p className="text-xs leading-3 text-gray-800 md:pt-0 pt-4">RF293</p> */}
                                                            <div className="flex items-center justify-between w-full pt-1">
                                                                <Link to={`/product/${item.product}`} className="text-base font-black leading-none text-gray-800">{item.name}</Link>
                                                                <p className="py-2 px-1  mr-6 focus:outline-none">
                                                                  Quantity: {item.qty}  
                                                                </p>
                                                            </div>
                                     ...
                                     <div className="xl:w-1/2 md:w-1/3 xl:w-1/4 w-full bg-gray-100 h-full md:hidden p-0">
